...
floorChartClass.prototype.reset_panzoom = function(){
	...
	this.zoom_initial_scale = 1;
	this.zoom_initial = this.scale_to_value(this.zoom_initial_scale)//(1-this.zoom_min_scale)/(this.zoom_max_scale-this.zoom_min_scale)*100;
	this.update_panzoom();
}
...
floorChartClass.prototype.update_panzoom = function(){
	...
	if (!this.panzoom_obj) this.panzoom_obj = this.panzoomRoot.find('.panzoom');
	this.panzoom_obj.panzoom("option",{
...
floorChartClass.prototype.setOption = function(option,type){
	...
	this.zoom_initial_scale = option.zoom_initial_scale || 1;
	this.zoom_initial = this.scale_to_value(this.zoom_initial_scale);
	...
	this.optionExt = option.optionExt || this.optionExt;
...
floorChartClass.prototype.ready = function(){
	...
	this.panzoomRoot.find('.panzoom').bind('reset',$.proxy(this.panzoomchange_func,this));
	this.refresh();
...
floorChartPlugin.has = function(divName){
	return floorChartPlugin.list[divName]!=null;
}
